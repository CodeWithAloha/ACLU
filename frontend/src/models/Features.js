...
import { RestrictionState, RestrictionStateType } from "./RestrictionState";
...
export class ParkFeature {
  ...
  getRestrictionState() {
    ...
    debugger;
    const href =
      process.env.ACLU_API_BASE_URL +
      '/feature_park_restrictions/?where={"feature_id":"###FEATURE_ID###"}';
    return Axios.get(href.replace("###FEATURE_ID###", this._id))
      ...
      .catch(err => {
        ...
        console.log(err);
        return new RestrictionState(RestrictionStateType.Valid, "LOREM IPSUM");
      });
  }
}
