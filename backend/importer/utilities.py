...
def get_api_resource_url(api_base_url, resource):
...
def get_organization(api_base_url, org_name):
    ...
    try:
        resource_base_url = get_api_resource_url(api_base_url, 'organizations')
...
def post_feature(api_base_url, feature_as_json):
    try:
        resource_base_url = get_api_resource_url(api_base_url, 'features')
